...
export function formatBlockerMessage(result: VenvBlockerScanResult): string {
  const lines = [
    'Update aborted: another Ethel process is using this installation.',
    '',
...
export function formatProbeFailedMessage(): string {
  return (
    'Update aborted: Desktop could not verify the Ethel installation is free.\n' +
    '\n' +
    'Close other Ethel windows and terminals, then retry.  If the problem\n' +
