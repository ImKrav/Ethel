...
// "Timed out connecting to Ethel backend" that hangs the UI (#48504).
//
...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Ethel gateway connection closed',
      connectErrorMessage: 'Could not connect to Ethel gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Ethel gateway is not connected',
